...
Ext.ux.PanelCollapsedTitle = (function(){
    ...
    this.init = function(p){
        if (p.collapsible || p.overrideCollapsible) {
            ...
            p.setCollapsedIconClass = function(cls){
                ...
                if (this.rendered && this.collapsedHeader) {
                    var hd = this.collapsedHeader, img = hd.child('img.x-panel-inline-icon');
                    ...
                    if (img) {
                        ...
                        Ext.DomHelper.insertBefore(hd.dom.firstChild, {
                            ...
                            style: verticalText ? 'display: block; margin: 1px 2px;' : 'margin-top: 2px; margin-right: 4px'
                        });
                    }
                }
            };
...
/*
 * Fix for sizing issues wiht Accordion, see:
 * http://www.sencha.com/forum/showthread.php?31069-UNKNOWN-2.x-3.x-BUG-GridPanel-inside-accordion-layout-forceFit-problem-IE6/page2
 */
...
if (Ext.ux.Andrie.pPageSize) {
    Ext.apply(Ext.ux.Andrie.pPageSize.prototype, {
        beforeText: "Resultados por p&#225;gina: ",
        afterText: ""
    });
}

/*
* To reset the value of combo when edit is empty
*/
