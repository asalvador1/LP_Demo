...
Ext.override(Ext.grid.GridPanel, {
        ...
        return '<xml version="1.0" encoding="utf-8">' +
            ...
            '<ss:Styles>' +
                '<ss:Style ss:ID="Default">' +
                    ...
                    '<ss:Font ss:FontName="Calibri" ss:Size="11" />' +
                    '<ss:Borders>' +
                ...
                '<ss:Style ss:ID="title">' +
                    '<ss:Font ss:Bold="1" ss:Size="11" ss:Color="#FFFFFF" />' +
                    '<ss:Interior ss:Pattern="Solid" ss:Color="#5C6F85" />' +
                ...
                '<ss:Style ss:ID="headercell">' +
                    ...
                    '<ss:Interior ss:Pattern="Solid" ss:Color="#5C6F85" />' + //Header
                '</ss:Style>' +
                '<ss:Style ss:ID="even">' +
                    '<ss:Interior ss:Pattern="Solid" ss:Color="#E4ECEA" />' + //1er Elemento
                '</ss:Style>' +
                ...
                '</ss:Style>' +
                '<ss:Style ss:ID="odd">' +
                    '<ss:Interior ss:Pattern="Solid" ss:Color="#F4F7F7" />' + ////2do Elemento
                '</ss:Style>' +
    ...
    createWorksheet: function (includeHidden) {
        ...
        for (var i = 0; i < cm.getColumnCount(); i++) {
            if (includeHidden || !cm.isHidden(i) && cm.config[i].dataIndex != "") {
        ...
        for (var i = 0, it = this.store.data.items, l = it.length; i < l; i++) {
            ...
            for (var j = 0; j < cm.getColumnCount(); j++) {
                if (includeHidden || !cm.isHidden(j) && cm.config[j].dataIndex != "") {
                    ...
                    else if (cellType[k] == 'String' && v == null) {
                        t += ' ';
                    }
                    else {
                        if (!Ext.isDate(v))
                            ...
                            var temp = v.toUTCString();
                            //t += temp.format('d M Y');
                            t += temp.substring(5, 16);                            
                        }
                    }
                    t += '</ss:Data></ss:Cell>';
                    k++;
